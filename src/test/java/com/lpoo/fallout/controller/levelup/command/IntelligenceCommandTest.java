...
class IntelligenceCommandTest {
    ...
    private IntelligenceCommand command;
    ...
    void setUp() {
        ...
        command = new IntelligenceCommand(mockedModel);
    }
    ...
    void leftEdge() {
        ...
        Assertions.assertEquals(0, command.getModel().getNewAttributes().getIntelligence());
    }
    ...
    void rightNormal() {
        ...
        Assertions.assertEquals(1, command.getModel().getNewAttributes().getIntelligence());
    }
    ...
    void leftNormal() {
        ...
        Assertions.assertEquals(0, mockedModel.getNewAttributes().getIntelligence());
    }
}