...
class StrengthCommandTest {
    ...
    private StrengthCommand command;
    ...
    void setUp() {
        ...
        command = new StrengthCommand(mockedModel);
    }
    ...
    void leftEdge() {
        ...
        Assertions.assertEquals(0, command.getModel().getNewAttributes().getStrength());
    }
    ...
    void rightNormal() {
        ...
        Assertions.assertEquals(1, command.getModel().getNewAttributes().getStrength());
    }
    ...
    void leftNormal() {
        ...
        Assertions.assertEquals(0, mockedModel.getNewAttributes().getStrength());
    }
}