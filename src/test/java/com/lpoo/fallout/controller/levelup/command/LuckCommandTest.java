...
class LuckCommandTest {
    ...
    void setUp() {
        ...
        command = new LuckCommand(mockedModel);
    }
    ...
    void leftEdge() {
        ...
        Assertions.assertEquals(0, command.getModel().getNewAttributes().getLuck());
    }
    ...
    void rightNormal() {
        ...
        Assertions.assertEquals(1, command.getModel().getNewAttributes().getLuck());
    }
    ...
    void leftNormal() {
        ...
        Assertions.assertEquals(0, mockedModel.getNewAttributes().getLuck());
    }
}